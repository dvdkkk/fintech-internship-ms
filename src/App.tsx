...
export default function App() {
  ...
  const navItems = [
    { name: "풀스택 개발자", href: "https://fintech-internship-fullstack-ms.vercel.app", external: true },
    { name: "서비스 기획자", href: "https://fintech-internship-serviceplanning-ms.vercel.app", external: true },
              ...
              {[
                {
                  ...
                  href: "https://fintech-internship-fullstack-ms.vercel.app"
                },
                {
                  ...
                  href: "https://fintech-internship-serviceplanning-ms.vercel.app"
                }
              ].map((item, idx) => (
                <motion.a 
                  key={idx} 
            ...
            <div className="space-y-6 mb-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-extrabold text-black">1644-7157</div>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-[#FFD600] shrink-0">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-2xl">
            ...
            <form 
              ...
              onSubmit={async (e) => {
                ...
                const data = {
                  _form_id: "0bada0dbfe62a5ead253657af762114e",
